...
const content = {
  es: {
    ...
    intro: 'Esta politica describe como se recopilan y utilizan los datos cuando visitas alambertt.dev.',
    sections: [
      {
        heading: 'Que datos se recopilan',
        items: [
          'Mensajes del chatbot: cuando el chatbot este activo, los mensajes se procesaran para generar respuestas. No se solicita ni almacena informacion personal identificable.',
      ...
      },
      {
        ...
        items: [
          'Los mensajes del chatbot se utilizan exclusivamente para generar respuestas contextuales sobre la experiencia profesional de Angel.',
      ...
      },
      {
        heading: 'Terceros',
        items: [
          'OpenAI: puede procesar mensajes del chatbot para generar respuestas cuando la integracion este activa.',
  ...
  en: {
    ...
    intro: 'This policy describes how data is collected and used when you visit alambertt.dev.',
    sections: [
      {
        heading: 'What data is collected',
        items: [
          'Chatbot messages: when the chatbot is active, messages are processed to generate responses. No personally identifiable information is requested or stored.',
      ...
      },
      {
        ...
        items: [
          "Chatbot messages are used exclusively to generate contextual responses about Angel's professional experience.",
      ...
      },
      {
        ...
        items: [
          'OpenAI: may process chatbot messages to generate responses when the integration is active.',
...
export default function PrivacyPolicy({ lang = 'es' }: { lang?: 'es' | 'en' }) {
  ...
  useEffect(() => {
    document.title = `${t.title} | alambertt.dev`
